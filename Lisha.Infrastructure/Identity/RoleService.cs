...
namespace Lisha.Infrastructure.Identity
{
    internal class RoleService : IRoleService
    {
        ...
        {
            return await _roleManager.Roles.ProjectToListAsync<RoleDto>(_mapper.ConfigurationProvider);
        }
        ...
        {
            return await _dbContext.Roles.ProjectTo<RoleDto>(_mapper.ConfigurationProvider).SingleOrDefaultAsync(x => x.Id == id) is { } role
            ? role
