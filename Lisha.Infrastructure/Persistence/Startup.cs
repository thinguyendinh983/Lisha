...
using Lisha.Infrastructure.Persistence.ConnectionString;
using Lisha.Infrastructure.Persistence.Context;
using Lisha.Infrastructure.Persistence.Initialization;
using Lisha.Infrastructure.Persistence.Repository;
using Microsoft.EntityFrameworkCore;
using Serilog;

namespace Lisha.Infrastructure.Persistence
{
            ...
            switch (dbProvider.ToLowerInvariant())
            {
                case DbProviderKeys.SqlServer:
                    return builder.UseSqlServer(connectionString, e =>
                         e.MigrationsAssembly("Lisha.Migrators.MSSQL"));
